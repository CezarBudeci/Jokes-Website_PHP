<div class="posts">
    <div class="row row-cols-2 justify-content-md-center pt-3">
        <div class="col-sm-2 text-end somecol">Sort by:</div>
        <div class="col-sm-2 mx-md-1 somecol">
        ...
        <!-- w-100 break the columns to two rows -->
        <div class="w-100"></div>
        <div class="col-sm-2 text-end somecol">Category:</div>
        <div class="col-sm-2 mx-md-1 somecol">
            <label class="visually-hidden">Categories</label>
            <select class="form-select oneselection" id="categories">
    ...
    <?php include "pagination.php"; ?> <!-- replace this with include mypagination.php in myposts.php-->
    </div>
</div>
